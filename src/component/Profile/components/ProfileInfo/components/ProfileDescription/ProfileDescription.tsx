...
export const ProfileDescription: VFC<ProfileDescriptionProps> = ({ profile, isAuthorizedUser, openEditProfileDialog }) => {
        ...
        <>
            ...
            <ul>
                ...
                <li className={classes.aboutItem}>
                    ...
                    <span className={classes.aboutItemValue}>{profile.lookingForAJobDescription ? profile.lookingForAJobDescription : '-'}</span>
                </li>
                {Object.keys(profile.contacts).map((contact) => {
                    return (
                        <li key={contact} className={classes.aboutItem}>
                            <p className={classes.aboutItemKey}>{contact}: </p>
                            <span className={classes.aboutItemValue}>{profile.contacts[contact as keyof ContactsType] ? profile.contacts[contact as keyof ContactsType] : '-'}</span>
                        </li>
                    )
                })}
            </ul>
