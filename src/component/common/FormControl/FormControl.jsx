...
export const InputLogin = ({ input, meta, className, ...props }) => {
  ...
  return (
    <div className={`login__input ${className}`}>
      <input
        className={classNames('login__inputText', { 'login__inputText--error': touched && error })}
        {...input}
        {...props}
      />
      {touched && error && (
        <div className='login__error'>
          ...
          <p className='login__errorText'>{error}</p>
        </div>
      )}
    </div>
  );
...
export const CheckBoxLogin = ({ input, meta, ...props }) => {
  return (
    <div className='login__checkbox'>
      ...
      <label className='login__checkboxLabel' htmlFor='checkbox'>
        Zapamiętaj mnie
      </label>
    </div>
  );
